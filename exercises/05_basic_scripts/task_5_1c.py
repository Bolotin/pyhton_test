...
device = input('Введите имя девайса: ')
param = input('Введите имя параметра ({}): '.format(', '.join(list(london_co[device].keys()))))
print(london_co[device].get(device, 'Такого параметра нет'))
